	...
	function (b) {
		return b
			...
			: function (b, c) {
					...
					for (var t = 0; t < p && c < l; ) if (f[c++] != b[t++]) return !1;
					return t >= p;
			  };
	},
	"es6",
...
!(function () {
	...
	if (!document.getElementById("top-1")) {
		...
		a.style = "display: none";
		a.innerHTML =
			'<a href="https://mobirise.in">Mobirise Site Software</a> Mobirise v5.5.5';
